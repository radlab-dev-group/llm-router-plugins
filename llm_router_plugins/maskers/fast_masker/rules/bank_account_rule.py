...
def _iban_mod97(iban: str) -> int:
    ...
    converted = "".join(str(ord(c.upper()) - 55) if c.isalpha() else c for c in rearranged)
...
class BankAccountRule(BaseRule):
    ...
    _IBAN_LENGTHS: dict[str, int] = {
        "AL": 28, "AD": 24, "AE": 23, "AT": 20, "BA": 20, "BH": 18,
        "BY": 29, "BE": 16, "BG": 22, "BR": 29, "CH": 21, "CR": 21,
        "CY": 28, "CZ": 24, "DE": 22, "DK": 18, "DO": 28, "EE": 20,
        "EG": 29, "ES": 24, "FI": 18, "FO": 18, "FR": 27, "GB": 22,
        "GE": 22, "GI": 23, "GL": 18, "GR": 27, "GT": 28, "HR": 21,
        "HU": 28, "IE": 22, "IQ": 23, "IR": 26, "IS": 26, "IT": 27,
        "JO": 30, "KW": 30, "KZ": 20, "LB": 28, "LC": 32, "LI": 21,
        "LT": 20, "LU": 20, "LV": 21, "MC": 27, "MD": 24, "ME": 22,
        "MK": 19, "MR": 27, "MT": 31, "MU": 30, "NL": 18, "NO": 15,
        "PK": 24, "PL": 28, "PS": 29, "PT": 25, "QA": 29, "RO": 24,
        "RS": 22, "SA": 30, "SC": 31, "SE": 24, "SI": 19, "SK": 24,
        "SM": 27, "ST": 25, "TL": 23, "TN": 24, "TR": 26, "UA": 29,
        "UK": 22, "VA": 22, "VG": 24,
    }
    ...
    def apply(
        ...
        for match in self.pattern.finditer(text):
            ...
            if anonymizer_fn:
                ...
                mappings.append({"original": candidate, "replacement": self.placeholder})
